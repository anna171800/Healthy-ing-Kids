...
selected3 = option_menu(None, ["육아일기", "닥터 아이봇",  "소아병원 찾기"], 
    icons=['person-bounding-box', 'menu-up', "arrow-down-left-circle-fill"], 
...
elif selection == None or selection == "육아일기":
    import openai
    import deepl
    import streamlit
    #초기화
    ...
    with tab1:
        ...
        if submit_button and diary_text:  # 일기 텍스트가 있을 때만 처리
            diary_prompt= """
                ...
                육아일기의 내용과, 아이의 정보를 고려해서 이 육아일기에 대한 감정적, 의료적 피드백을 200자 이내로 세 항목으로 해줘."""%(diary_text, gender, height, weight, age)
